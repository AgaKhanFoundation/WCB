...
db.team.belongsToMany(db.achievement, {through: 'team_achievement'}) // TODO use db.team_achievement
...
db.fcmtoken.belongsTo(db.participant) // TODO add participant.hasMany(db.fcmtoken)
...
db.participant.belongsToMany(db.notification, {through: 'participant_notification'})
db.notification.belongsToMany(db.participant, {through: 'participant_notification'})
